# preprocess.py
# This script reads movie_results.csv (output from the Hadoop MapReduce job),
# filters only the popular movies (isPopular == "Yes") with at least 10 ratings,
# normalizes movie titles like "Great Escape, The" to "The Great Escape",
# sorts them by average rating (descending),
# and writes the cleaned output to both a .txt and .csv file for further use.
...
TXT_OUTPUT = "./output/final_movie_list.txt"        # Tab-separated output (for terminal/testing)
...
def main():
    ...
    # Write tab-separated .txt file (no quotes, no isPopular field)
